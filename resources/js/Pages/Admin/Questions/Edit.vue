        ...
        <form @submit.prevent="update">
          <div class="flex flex-col gap-4 md:px-16">
            ...
            <div class="flex flex-col md:flex-row gap-4 mt-4">
              <button type="submit" class="btn-success">ثبت سوال</button>
              <Link
                v-if="question.deleted_at !== null"
                :href="route('admin.questions.restore', props.question.id)"
                as="button"
                method="put"
                class="btn-primary"
              >
              ...
              <Link
                v-if="(question.deleted_at === null) & (question.status == 1)"
                :href="route('admin.questions.active', props.question.id)"
                as="button"
                method="put"
                class="btn-danger"
              >
              ...
              <Link
                v-if="(question.deleted_at === null) & (question.status == 2)"
                :href="route('admin.questions.suspend', props.question.id)"
                as="button"
                method="put"
                class="btn-danger"
              >
...
const breadcrumbs = [
  ...
  {
    label: "ویرایش سوال",
    url: route("admin.questions.edit", props.question.id),
  },
];
