<template>
  ...
  <GuestLayout title="صفحه نخست">
    <!-- Features -->
    <section
      class="flex flex-col md:flex-row justify-center items-center gap-8 lg:gap-12 mx-4 mt-8 lg:my-12"
    >
      <div
        v-for="game in games"
    ...
    <!-- The 3 tops -->
    <section
      class="bg-[url('/images/top-users.webp')] bg-no-repeat bg-cover bg-center flex w-full pt-16 bg-slate-500 justify-center items-end gap-8 my-8"
    >
      <TopUser class="order-2 h-32 transition-ease-out-500">
        <img
          src="/images/medals/gold.webp"
          class="absolute w-12 mt-[-75px] mr-11"
        />
        احمد احمدپور
      </TopUser>
      <TopUser class="order-3 h-28 transition-ease-out-500">
        <img
          src="/images/medals/silver.webp"
          class="absolute w-12 mt-[-75px] mr-11"
        />
        حامد احمدپور
      </TopUser>
      <TopUser class="order-1 h-24 transition-ease-out-500">
        <img
    ...
    <!-- Sponsors -->
    <section class="my-12 flex justify-center gap-8">
      <div
        v-for="sponsor in sponsors"
        class="group w-1/4 hover:opacity-70 transition-ease-out-500"
      >
...
import TopUser from "@/Pages/FrontPage/Components/TopUser.vue";
